...
![@hutechwebsite/fugit-architecto-odit-numquam-diagram-verify](https://cloud.githubusercontent.com/assets/194400/11937081/00f9b4bc-a80a-11e5-9f71-a7e05e92f1ae.png)

[![Known Vulnerabilities](https://snyk.io/test/github/dwyl/@hutechwebsite/fugit-architecto-odit-numquam/badge.svg?targetFile=package.json&style=flat-square)](https://snyk.io/test/github/dwyl/@hutechwebsite/fugit-architecto-odit-numquam?targetFile=package.json)
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/dwyl/@hutechwebsite/fugit-architecto-odit-numquam/ci.yml?label=build&style=flat-square&branch=main)
[![codecov.io](https://img.shields.io/codecov/c/github/dwyl/@hutechwebsite/fugit-architecto-odit-numquam/main.svg?style=flat-square)](http://codecov.io/github/dwyl/@hutechwebsite/fugit-architecto-odit-numquam?branch=main)
[![Inline docs](http://inch-ci.org/github/dwyl/@hutechwebsite/fugit-architecto-odit-numquam.svg?branch=main&style=flat-square)](http://inch-ci.org/github/dwyl/@hutechwebsite/fugit-architecto-odit-numquam)
[![HAPI 21.1.0](http://img.shields.io/badge/hapi-21.1.0-brightgreen.svg?style=flat-square "Latest Hapi.js")](http://hapijs.com)
[![Node.js Version](https://img.shields.io/node/v/@hutechwebsite/fugit-architecto-odit-numquam.svg?style=flat-square "Node.js 18.x, 20.x & 21.x supported")](http://nodejs.org/download/)
[![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat-square)](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues)
[![HitCount](http://hits.dwyl.com/dwyl/@hutechwebsite/fugit-architecto-odit-numquam.svg)](http://hits.dwyl.com/dwyl/@hutechwebsite/fugit-architecto-odit-numquam)
[![npm package version](https://img.shields.io/npm/v/@hutechwebsite/fugit-architecto-odit-numquam.svg?style=flat-square)](https://www.npmjs.com/package/@hutechwebsite/fugit-architecto-odit-numquam)
...
https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues

### Install from NPM

```sh
npm install @hutechwebsite/fugit-architecto-odit-numquam --save
```
...
const init = async () => {
  ...
  // include our module here ↓↓, for example, require('@hutechwebsite/fugit-architecto-odit-numquam')
...
```sh
git clone https://github.com/hutechwebsite/fugit-architecto-odit-numquam.git && cd @hutechwebsite/fugit-architecto-odit-numquam
```
...
signature `async function(decoded)` where:
    ...
    - Returns an object `{ key, extraInfo }` where:
        ...
        via `request.plugins['@hutechwebsite/fugit-architecto-odit-numquam'].extraInfo`
    - Throws a Boom error when key lookup fails.  Refer to [this example implementation](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/blob/main/test/dynamic_key_server.js)
    and [its associated test](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/blob/main/test/dynamic_key.test.js) for a working example.
...
[@hutechwebsite/fugit-architecto-odit-numquam/issues/123](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/123)


### Understanding the Request Flow

At the simplest level this is the request flow through a Hapi App
using `@hutechwebsite/fugit-architecto-odit-numquam`:
...
This feature was requested in: [issues/29](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/29)
...
[dwyl/@hutechwebsite/fugit-architecto-odit-numquam/issues/**19**](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/19)
...
> Set your `urlKey` to `false` or ''. (*added by* @bitcloud: [issue #146](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/pull/146))

## Generating Your Secret Key

@skota asked "***How to generate secret key***?" in: [dwyl/@hutechwebsite/fugit-architecto-odit-numquam/issues/**48**](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/48)
...
[dwyl/@hutechwebsite/fugit-architecto-odit-numquam/issues/**123**](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/123)
...
[dwyl/@hutechwebsite/fugit-architecto-odit-numquam/issues/**55**](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/55)
...
[https://github.com/nelsonic/@hutechwebsite/fugit-architecto-odit-numquam-cookie-example](https://github.com/nelsonic/@hutechwebsite/fugit-architecto-odit-numquam-cookie-example)
...
[given that **@hutechwebsite/fugit-architecto-odit-numquam** plugin already includes it] ? asked in 
[@hutechwebsite/fugit-architecto-odit-numquam/issues/32](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/32)  
...
Even though **@hutechwebsite/fugit-architecto-odit-numquam** includes it
...
`const JWT = require('./node_modules/@hutechwebsite/fugit-architecto-odit-numquam/node_modules/jsonwebtoken');`
...
in [issue #120](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/120) and [issue #130](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/130) respectively.
...
### Can I use `@hutechwebsite/fugit-architecto-odit-numquam` with [`glue`](https://github.com/hapijs/glue)
...
[https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/151#issuecomment-218321212](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/151#issuecomment-218321212)

<br />

### How do I *invalidate* an *existing token*?

Asked by [@SanderElias](https://github.com/SanderElias) in [@hutechwebsite/fugit-architecto-odit-numquam/issues/126](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/126)

We store our JWT-based sessions in a Redis datastore and lookup the session (`jti`) for the given JWT during the `validate` (*validation function*) see: 
[https://github.com/hutechwebsite/fugit-architecto-odit-numquam-example/blob/791b0d3906d4deb256daf23fcf8f5021905abe9e/index.js#L25](https://github.com/hutechwebsite/fugit-architecto-odit-numquam-example/blob/791b0d3906d4deb256daf23fcf8f5021905abe9e/index.js#L25)
...
[@abeninskibede](https://github.com/abeninskibede) asked how to set all routes to use JWT Auth in [@hutechwebsite/fugit-architecto-odit-numquam/issues/149](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/149)

We tend to enable `@hutechwebsite/fugit-architecto-odit-numquam` for *all* routes by setting the default strategy to 'jwt' (so its `required` for all endpoints) because *most* of the endpoints in our app require the person/user to be authenticated e.g:
...
[ask!](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues)

### How to *redirect* if a token has expired?

@traducer & @goncalvesr2 both requested how to redirect after failed Auth in
[@hutechwebsite/fugit-architecto-odit-numquam/issues/161](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/161)
and [@hutechwebsite/fugit-architecto-odit-numquam/issues/148](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/148) respectively

The [`hapi-error`](https://github.com/dwyl/hapi-error) lets
you *easily* redirect to any url you define if the Auth check fails
(i.e. `statusCode 401`)
see:
[https://github.com/dwyl/hapi-error#redirectredirecting-to-another-endpoint](https://github.com/dwyl/hapi-error#redirectredirecting-to-another-endpoint)
(*code examples there.*)
...
While *most* people using `@hutechwebsite/fugit-architecto-odit-numquam` will opt for the *simpler* use case
(*using a* ***Validation Function*** *`validate` - see: Basic Usage example above - which validates the JWT payload after it has been verified...*)
others may need more control over the `verify` step.

The [*internals*](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/blob/eb9fff9fc384fde07ec2a1d2f0da520be902da2c/l˜/index.js#L58)
of `@hutechwebsite/fugit-architecto-odit-numquam` use the `jsonwebtoken.verify` method to ***verify*** if the
JWT was signed using the `JWT_SECRET` (*secret key*).
...
[https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/120](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/120)
...
**`@hutechwebsite/fugit-architecto-odit-numquam`** version **`10.x.x`** is an ***optional upgrade***
...
**`@hutechwebsite/fugit-architecto-odit-numquam`** version **`9.x.x`** is compatible with **Hapi.js `19.x.x`**
which only supports **Node.js 12+**.
While **`@hutechwebsite/fugit-architecto-odit-numquam`** version `9.0.0`
...
[dropped support for Node.js 10](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/338#issuecomment-583716612)
and people should treat *this* package
as no longer supporting the older versions of Node. <br />

`@hutechwebsite/fugit-architecto-odit-numquam` version `8.x.x`
is compatible with Hapi.js version `17.x.x` - `19.x.x` <br />

`@hutechwebsite/fugit-architecto-odit-numquam` version `7.x.x` is compatible with `16.x.x`
`15.x.x` `14.x.x` `13.x.x` `12.x.x` `11.x.x` `10.x.x` `9.x.x` and `8.x.x`
Hapi `17.x.x` is a *major* rewrite that's why version `8.x.x`
...
> *If you have a question, or need help getting started* ***please post an issue/question on GitHub***: https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues
...
The ***code*** is at: https://github.com/hutechwebsite/fugit-architecto-odit-numquam-example
...
[@hutechwebsite/fugit-architecto-odit-numquam/issues/9](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues/9)
...
- **app.js** ***registering*** the **@hutechwebsite/fugit-architecto-odit-numquam plugin**:
...
## Contributing [![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues)

If you spot an area for improvement,
please raise an issue:
https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues <br />
...
## Why @hutechwebsite/fugit-architecto-odit-numquam ?
...
to improve (*security*) it was *ignored* for *weeks* ... an *authentication* plugin that [***ignores security updates***](https://github.com/ryanfitz/hapi-auth-jwt/issues/26) in [dependencies](https://david-dm.org/ryanfitz/hapi-auth-jwt)
is a ***no-go*** for us; **security** ***matters***!) If you spot *any*
issue in ***@hutechwebsite/fugit-architecto-odit-numquam*** please create an issue: https://github.com/hutechwebsite/fugit-architecto-odit-numquam/issues
so we can get it *resolved* ASAP!

*Aparently, `.some` people like it...*:

[![https://nodei.co/npm/@hutechwebsite/fugit-architecto-odit-numquam.png?downloads=true&downloadRank=true&stars=true](https://nodei.co/npm/@hutechwebsite/fugit-architecto-odit-numquam.png?downloads=true&downloadRank=true&stars=true)](https://www.npmjs.com/package/@hutechwebsite/fugit-architecto-odit-numquam)
